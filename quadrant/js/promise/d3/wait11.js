...
module.exports =  function waitPromise8(param) {
    ...
    function hexToRgb(hex) { //TODO rewrite with vector output
        ...
        // renderer
        var container = document.getElementById("a21");
...
//renderer.setSize(container.offsetWidth, container.offsetHeight);
        ...
        var data = d3.csv("./csv/citybike_10k_3d_600.csv", function (d) {

            d.forEach(function (d,i) {

                    unfiltered[i] = {
                        //x: +d.x,
                        x: +d.start_station_id,
                        y: +d.tripduration,
                        z: +d.end_station_id
                    };
            ...
            */
            ...
            for (var i = 0; i < pointCount; i ++) {
                ...
                //pointGeo.vertices.push(new THREE.Sphere(new THREE.Vector3(x, y, z),3));
